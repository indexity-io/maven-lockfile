...
- `allowRepositoryValidationFailure` (`-DallowRepositoryValidationFailure=true`, default=`false`) allow validation failure of the repository details of artifacts without failing validation. In case of a mismatch, a warning is printed instead of an exception.
